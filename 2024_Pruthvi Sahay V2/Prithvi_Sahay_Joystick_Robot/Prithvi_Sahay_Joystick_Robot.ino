...
Servo myservoSoil, myservoSeed, myservoTX;   // create servo object to control a servo 
...
void setup() {
  ...
  myservoSeed.attach(D7);  //D7
  myservoTX.attach(1); // GPIO1 (TX pin)
...
void loop() {
    server.handleClient();
      ...
      else if (command.startsWith("ServoTX")) {
       String sliderValue = command.substring(7); // Extract slider value .toInt()
       //Serial.println(sliderValue);
       if (sliderValue == "0") myservoTX.write(180);
       else if (sliderValue == "1") myservoTX.write(1600);
       else if (sliderValue == "2") myservoTX.write(140);
       else if (sliderValue == "3") myservoTX.write(120);
       else if (sliderValue == "4") myservoTX.write(100);
       else if (sliderValue == "5") myservoTX.write(80);
       else if (sliderValue == "6") myservoTX.write(60);
       else if (sliderValue == "7") myservoTX.write(40);
       else if (sliderValue == "8") myservoTX.write(20);
       else if (sliderValue == "9") myservoTX.write(0);
       }
